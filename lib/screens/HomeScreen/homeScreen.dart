...
import 'package:guily_app/screens/photos_and_videos/photosandvideos.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Stack(
          children: [
            listView ? buildListScreen(context) : buildGridScreen(context),
            Align(
  ...
  Widget buildGridScreen(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          SizedBox(height: MediaQuery.of(context).size.height * 0.2),
          selected ? buildGrid2(context) : buildGrid(context),
          // buildGrid(),
        ],
      ),
    );
